...
define config.name = _("Gachipunk 3season")
...
define gui.about = _p("""Гачипанк Димитрик оказался в визуальной новелле. Помогите ему найти себя. А взамен он поможет вам.
""")
...
define build.name = "Gachipunk3season"
...
define config.main_menu_music = "gui/menu_music.mp3"
...
define config.save_directory = "Gachipunk3season-1708257781"
